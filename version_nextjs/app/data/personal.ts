...
export const aboutMe = {
  ...
  highlights: [
    { icon: "magnifier-icon", text: "Curious about how systems work and how to improve them" },
    { icon: "gear-icon", text: "Love building real, usable software" },
    { icon: "globe-icon", text: "Focused on local impact with scalable ideas" },
    { icon: "hand-heart-icon", text: "Active in volunteering, events, and youth development" },
  ],
  stats: [
